...
cp "$ROOT_DIR/state/exports/apt-manual-packages.txt" "$ROOT_DIR/manifests/apt-packages.txt"
...
log_warn "APT manifest has been refreshed from the live machine. Review it before committing, because apt-mark showmanual can include transitional and dependency-shaped packages."
